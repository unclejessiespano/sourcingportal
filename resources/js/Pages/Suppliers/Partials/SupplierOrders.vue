...
const props = defineProps(['orders', 'lines'])
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <ul role="list" class="divide-y divide-gray-100">
            <li class="flex flex-wrap items-center justify-between gap-x-6 gap-y-4 py-5 sm:flex-nowrap">
                <div>&nbsp;</div>
                <div><p class="text-sm font-bold leading-6 text-gray-900">Due Date</p></div>
                <div><p class="text-sm font-bold leading-6 text-gray-900">PO</p></div>
                <div><p class="text-sm font-bold leading-6 text-gray-900">SKU</p></div>
                <div>&nbsp;</div>
            </li>
        <li v-for="line in lines" :key="line.id" class="flex flex-wrap items-center justify-between gap-x-6 gap-y-4 py-5 sm:flex-nowrap">
            <div v-html="formatStatusBadge(moment(line.delivery_date).format('L'))"></div>
            <div><p class="text-sm font-semibold leading-6 text-gray-900">{{moment(line.delivery_date).format('L')}}</p></div>
            <div>
                <p class="text-sm font-semibold leading-6 text-gray-900">
                    <a href="discussion.href" class="hover:underline">{{line.order.PO}}</a>
                </p>
            </div>
            <div>
                <p class="text-sm font-semibold leading-6 text-gray-900 text-center">
                    <a href="discussion.href" class="hover:underline">{{line.sku.sku}}</a>
                </p>
            </div>
            <div>
