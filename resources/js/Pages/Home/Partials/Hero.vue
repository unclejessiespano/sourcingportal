                ...
                <div class="px-6 pt-6 lg:max-w-2xl lg:pl-8 lg:pr-0">
                    <nav class="flex items-center justify-between lg:justify-start" aria-label="Global">
                        <a href="#" class="-m-1.5 p-1.5">
                            <span class="sr-only">Mouker</span>
            ...
            <Dialog as="div" class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
                ...
                <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                    <div class="flex items-center justify-between">
                        <a href="#" class="-m-1.5 p-1.5">
                            <span class="sr-only">Mouker</span>
                            <img class="h-8 w-auto" src="/images/corbus_logo.png" alt="" />
                        </a>
                ...
                <div class="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
                    ...
                    <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
                        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                            <div v-if="1==2" class="hidden sm:mb-10 sm:flex">
                            ...
                            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Providing supply chain visability</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-600">Mouker provide a complete view of your supply chain by managing your suppliers, understanding your network of subtier suppliers, and triaging at-risk lines.</p>
                            <div v-if="1==1" class="mt-10 flex items-center gap-x-6">
